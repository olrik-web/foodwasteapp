...
{
    public $error = null;
    private $server = "pardesyar.dk.mysql.service.one.com"; // Change to domain name, e.g. www.iloveunicorns.com
    private $username = "pardesyar_dkwordpress"; // Change to the admins username of the server
    private $password = "hamidersej00"; // Change to the admins password of the server
    private $database = "pardesyar_dkwordpress"; // Change to the name of the database you would like to connect to on the server
